function mainMessage(message){
    message.reply(`💙 היי וברוכים הבאים למערך תקשוב חטיבה 5 💙\n
        ...
        0️⃣ - בשביל לקבל את ההודעה הזאת שוב.
...
function windowsProblems(message){
    message.reply(`היי, לפניך מספר פתרונות לתקלות שיכולות להיות לך בווינדואוס
        במידה והפתרונות האלו לא עוזרות, יש לפנות לנציג המחשוב הזמין
        \n
        ...
        יש לבקש ממנו לשמור.
        \n
        במידה אתם רוצים לפתוח תיקיית רשת יש לוודא שיש לכם הרשאות לתיקיית רשת זו, במידה ואין לכם תיקיית רשת זו יש לפנות אל בעלי התיקייה
        לדוגמא: אם רשום ug0162vfs/h5 זאת אומרת שהתיקייה היא תחת חטיבה 5 לכן יש לבקש מאנשי המחשוב הרשאות לתיקייה.
        `)
}
...
function SBProblems(message){
    message.reply(`
        היי, לפניך מספר פתרונות לתקלות שיכולות להיות לך הקשורות למשואה,
        במידה והפתרונות האלו לא עוזרות, יש לפנות לנציג המחשוב הזמין.
        \n
        במידה ואתם גולשים בצייד ורשום לכם Invalid username or password, יש להוציא את הכרטיס מהקורא כרטיסים, לחבר אותו החזרה ולעשות ריפרש לעמוד
        \n
        במידה והצייד לא עולה לכם אבל כן יש אינטרנט ואתם מצליחים לגלוש לאתרים אחרים, יש להוסיף לקישור של הצייד -mr שיראה ככה:
        https://zayad-mr.שאר הכתובת`)
}
...
module.exports = { mainMessage, workInProgress, ideasMessage, computerProblem, otherProblems, windowsProblems, telephoneProblems, internetProblems, SBProblems };
